...
```{r bsdb_basic, warning=FALSE, message=FALSE, fig.height=8, fig.width=8}
...
```{r bsdb_basic2, warning=FALSE, message=FALSE, fig.height=8, fig.width=8}
...
```{r bsdb_basic_network, warning=FALSE, message=FALSE, fig.height=8, fig.width=8}
...
```{r bsdb_basic_network_mb, warning=FALSE, message=FALSE, fig.height=8, fig.width=8}
...
```{r bsdb_basic_network_dis, warning=FALSE, message=FALSE, fig.height=10, fig.width=10}
...
```{r no_curate, warning=FALSE, message=FALSE, fig.height=10, fig.width=10}
