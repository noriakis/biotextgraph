...
One of the main questions is which words can be clustered together among the words contained in the cluster, 
...
One can compare two networks by providing two objects produced by wc* functions.
...
compareWordNet(net1, net3, titles=c("ercc","ercc-PubMed"))
